        ...
        <div className="space-y-12">
          ...
          <div className="space-y-4 text-center md:text-left border-b border-slate-200 pb-8">
            ...
            <p className="text-lg text-slate-600 leading-relaxed font-medium">
              We engineer AI Open House Connect to comply with local regulatory real estate frameworks, privacy consent mandates, and voice synthesis authorization policies.
            </p>
          </div>
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-sm md:text-base leading-relaxed text-slate-600">
            <section className="space-y-3">
              ...
              <p>
                AI Open House Connect provides automated follow-ups for real estate listings. Every time a buyer interacts with the AI voice or chat tour and bypasses the Lead Gate:
              </p>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Honest AI Labeling:</strong> Distinct status lines notify buyers that they are speaking with an "AI Assistant developed by AI Open House Connect on behalf of the listing team."</li>
            ...
            <section className="space-y-3">
              ...
              <p>
                Data security remains at the core of legal compliance. AI Open House Connect manages databases using firestore.rules mapping to avoid unauthenticated reads, while server proxy routes hide sensitive API keys and secrets from front-end dev inspect frames.
              </p>
              <div className="mt-4 p-4 bg-emerald-50 rounded-2xl flex gap-3 text-emerald-850 border border-emerald-100">
                <CheckCircle className="h-5 w-5 text-emerald-600 shrink-0" />
                <p className="text-xs font-semibold">
                  AI Open House Connect is fully compliant with modern data protection standards, secure credential parameters, and regulatory real estate governance formats.
                </p>
              </div>
            </section>
          </div>
